      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b border-border">
        <div className="container mx-auto px-2 sm:px-4 py-3 flex justify-between items-center">
          <div className="flex items-center">
            <img src="/lovable-uploads/91791353-fd2d-4472-9b14-67723fe916c4.png" alt="Lasmar Telemed" className="h-8 sm:h-10 md:h-12 w-auto cursor-pointer hover:scale-105 transition-transform" onClick={() => window.open('https://www.telemedlasmar.com.br/', '_blank')} />
          </div>
          
          <div className="flex gap-1 sm:gap-2 md:gap-3">
            <Button onClick={() => handleNavigate('/auth')} variant="outline" size="sm" className="border-primary text-primary hover:bg-primary hover:text-white text-xs sm:text-sm px-2 sm:px-3">
              <UserPlus className="h-3 w-3 sm:h-4 sm:w-4 mr-1 sm:mr-2" />
              <span className="hidden sm:inline">Área do </span>Profissional
            </Button>
            <Button onClick={() => handleNavigate('/admin/auth')} variant="outline" size="sm" className="border-secondary text-secondary hover:bg-secondary hover:text-white text-xs sm:text-sm px-2 sm:px-3">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            <div className="mb-6 sm:mb-8">
              <img src="/lovable-uploads/91791353-fd2d-4472-9b14-67723fe916c4.png" alt="Lasmar Telemed" className="h-16 sm:h-24 md:h-32 lg:h-40 w-auto mx-auto mb-4 sm:mb-8 hover-scale cursor-pointer" onClick={() => window.open('https://www.telemedlasmar.com.br/', '_blank')} />
            </div>
            ...
            <div className="mt-8 sm:mt-12 rounded-2xl overflow-hidden shadow-2xl max-w-3xl mx-auto">
              <img src={medicalTeamTelemed} alt="Médicos em teleconsulta" className="w-full h-48 sm:h-64 md:h-80 object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16 bg-white">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <Button onClick={() => handleNavigate('/auth')} size="lg" className="bg-gradient-primary hover:scale-105 transition-all duration-300 px-6 sm:px-8 md:px-12 py-4 sm:py-6 text-lg sm:text-xl font-semibold shadow-xl w-full sm:w-auto">
              Cadastre-se agora
            </Button>
          </div>
        </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <img src={doctorTeleconsult2} alt="Médico, marketing digital e pacientes conectados" className="w-full h-80 object-cover rounded-2xl shadow-xl" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex justify-center items-center">
              <Button onClick={() => handleNavigate('/auth')} size="lg" variant="outline" className="bg-white text-primary hover:bg-gray-100 border-white px-6 sm:px-8 md:px-12 py-4 sm:py-6 text-lg sm:text-xl font-semibold shadow-xl hover:scale-105 transition-all duration-300 w-full sm:w-auto">
                Trabalhe Conosco
              </Button>
            </div>
            
            <div className="mt-12 rounded-2xl overflow-hidden shadow-2xl max-w-2xl mx-auto">
              <img src={medicalTeamTelemed} alt="Médicos sorrindo em vídeo chamada" className="w-full h-48 object-cover opacity-90" />
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="py-8 border-t bg-card/50 backdrop-blur-sm">
        <div className="container mx-auto px-4 text-center">
          <div className="flex justify-center mb-4">
            <img src="/lovable-uploads/91791353-fd2d-4472-9b14-67723fe916c4.png" alt="Lasmar Telemed" className="h-8 w-auto opacity-70" />
          </div>
