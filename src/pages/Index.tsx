              ...
              <div className="space-y-6">
                <div className="text-lg leading-relaxed text-muted-foreground space-y-4">
                  ...
                  <div className="space-y-3 mt-6">
                    ...
                    <div className="flex items-start gap-3">
                      <ArrowRight className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                      <span>Para trabalhar conosco não há mensalidade nem custo de adesão. Você só paga uma taxa sobre cada consulta realizada, e todos os outros serviços são opcionais.</span>
                    </div>
                    <div className="flex items-start gap-3">
                      <ArrowRight className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                  ...
                  <div className="bg-red-50 border border-red-200 p-4 rounded-lg">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="text-sm text-red-700">
                        <strong className="text-base">Observação:</strong> Para se tornar cooperado, é preciso atender aos <strong>pré-requisitos da plataforma.</strong> Trabalhamos apenas com especialidades que já possuem demanda comprovada em teleconsulta, o que garante maior segurança no retorno do investimento. Vale lembrar que a adesão ao serviço de cooperado é <strong>totalmente opcional</strong>.
                      </div>
                    </div>
                  </div>
                </div>
