...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.stage_progress TO authenticated;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.interview_fields TO authenticated;
GRANT ALL ON public.interview_fields TO service_role;
